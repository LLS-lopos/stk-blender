...
class STKmenu(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        layout.operator("node.add_node",
                        text=capture_flag_info.STK_capture_flag.bl_label).type = capture_flag_info.STK_capture_flag.bl_idname
        layout.operator("node.add_node",
                        text=cutscene_info.STK_cut_scene.bl_label).type = cutscene_info.STK_cut_scene.bl_idname
        ...
        layout.operator("node.add_node",
                        text=time_trial.STK_time_trial.bl_label).type = time_trial.STK_time_trial.bl_idname
...
class STKoption(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        layout.operator("node.add_node",
                        text=initial_info.STK_initial.bl_label).type = initial_info.STK_initial.bl_idname
...
class STKdebug(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        layout.operator_context = 'INVOKE_DEFAULT'
        layout.operator("node.add_node",
                        text=controller.STK_debug_controller.bl_label).type = controller.STK_debug_controller.bl_idname
        layout.operator("node.add_node",
                        text=graphique.STK_debug_graphique.bl_label).type = graphique.STK_debug_graphique.bl_idname
